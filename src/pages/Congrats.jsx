...
const Congrats = () => {
  ...
  const handleReviewSubmit = (rating, review) => {
    ...
    // Simpan data ke backend jika diperlukan
  };
    ...
    <div className="bg-[#F5F5F5] min-h-screen font-sans text-[#222]">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6 px-4 py-10">
        ...
        <div className="lg:col-span-2">
          <img
            src="congratsgambar.png"
            alt="Congrats"
            className="w-full rounded-xl mb-8"
          />

          <div className="bg-white rounded-xl shadow p-6">
            <h2 className="text-sm text-gray-500 mb-2 font-medium">Tanggal Quiz:</h2>
            <p className="text-sm text-gray-800 mb-4">{tanggal.replace(",", " pukul")}</p>

            <div className="grid grid-cols-4 gap-4 text-center mb-6">
              <div className="bg-green-500 text-white py-4 px-2 rounded-xl">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="bg-yellow-400 hover:bg-yellow-500 transition text-white w-full py-2 rounded font-semibold text-sm"
          >
            ⭐ Beri Review & Rating
          </button>
        </div>
